"""new version with trainer

Revision ID: f80b5eda408b
Revises: 
Create Date: 2026-03-06 21:31:46.579065
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_trainers_email'), 'trainers', ['email'], unique=False)
